...
* `setStyleSheet` 使用样式表。此处使用的是如下的样式配置
    ...
    * 含义是设置 QLabel 的 背景 颜色是 rgb(238,228,218) <div id="rectangle" style="width:20px; height:20px; background-color:rgb(238,228,218)"></div>

    * 内容颜色是 rgb(119,110,101) <div id="rectangle" style="width:20px; height:20px; background-color:rgb(119,110,101)"></div>
