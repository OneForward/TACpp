...
示例代码在 [test_base.cpp](https://github.com/OneForward/TACpp/blob/github/codes/输出格式化/test_base.cpp), [test_fill_width.cpp](https://github.com/OneForward/TACpp/blob/github/codes/输出格式化/test_fill_width.cpp)
