...
示例代码在 [test_base.cpp](https://gitee.com/OneForward/TACpp/blob/gitee/tutorials/codes/test_base.cpp), [test_fill_width.cpp](https://gitee.com/OneForward/TACpp/blob/gitee/tutorials/codes/test_fill_width.cpp)
